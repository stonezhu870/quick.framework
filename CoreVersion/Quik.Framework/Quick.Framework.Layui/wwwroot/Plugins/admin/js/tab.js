...
layui.define(['jquery', 'element', 'nprogress', 'utils'], function(exports) {
    ...
    Tab.fn.CurrentNaviTab=function() {
        return _tab.CurrentNaviTab();
    }
    //私用对象
    var _tab = {
        _config: {},
        ...
        tabAdd: function(options) {
            ...
            _config.renderType = options.renderType || 'page';
            NProgress.start();
            if (_config.openWait)
                loadIndex = that.load();
        ...
        CurrentNaviTab: function () {
            return this._content.find('div.layui-tab-item.layui-show');
        }
    };
